...
#define N 1000
#define K 4
#define MIN_STEPS_IN_A_DIRECTION_BEFORE_TURNING 4
#define MAX_STEPS_IN_A_DIRECTION 10
...
int main() {
  ...
  while (!Q.empty()) {
    ...
    if (x == n - 1 && y == m - 1 && steps >= MIN_STEPS_IN_A_DIRECTION_BEFORE_TURNING) {
      cout << dxy << endl;
      return 0;
    }
    ...
    if (steps >= MIN_STEPS_IN_A_DIRECTION_BEFORE_TURNING) {
